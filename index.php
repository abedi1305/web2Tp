...
<html lang="en">
<head>
  <title>TpWeb2-Abedi-et-Lufuluabo</title>
  <meta charset="utf-8">
...
<body>
  <div class="container mt-2">
        ...
        <h4>2. Inscription des etudiants</h4>
          <div class="form-group">
            <button class="btn btn-info" data-toggle="modal" data-target="#etudiant" style="background-color: red;">new etudiant</button>    
         </div>
            <br>
            <?php echo '<p>'.$langue.'</p>' ?>
            ...
            <div class="col-md-3">
              <div class="container">
                ...
                <form action="index.php" method="POST">
                  ...
                  <input type="submit" class="btn btn-info" value="Valider" style="background-color: red;">
                </form>
                <label for="">DAY</label>
              ...
              <div class="container">
                ...
                <form action="index.php" method="POST">
                    ...
                    <input type="submit" class="btn btn-info" value="Ajouter" style="background-color: red;">
        ...
        <div class="modal-body">
          <form action="index.php" method="POST">
            <div class="row">
              ...
              <input type="submit" class="btn btn-info" value="Executer" style="background-color: red;">
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="index.php" method="POST">
              ...
              <input type="submit" class="btn btn-info" value="Calculer" style="background-color: red;">
          </form>
        </div>
      </div>
    </div>
